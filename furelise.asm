...
fur_elise_1:
	db	0,40,3, 0,39,3, 0,40,3, 0,39,3, 0,40,3, 0,35,3, 0,38,3, 0,36,3
	db	1,9,33,2, 1,16,33,2, 1,21,33,2
	db	0,24,3, 0,28,3, 0,33,3
	db	1,4,35,2, 1,16,35,2
	db	0,20,3, 0,28,3, 0,32,3, 0,35,3
	db	1,9,36,2, 1,16,36,2, 1,21,36,2, 0,28,3
	db	0,40,3, 0,39,3, 0,40,3, 0,39,3, 0,40,3, 0,35,3, 0,38,3, 0,36,3
	db	1,9,33,2, 1,16,33,2, 1,21,33,2
	db	0,24,3, 0,28,3, 0,33,3
	db	1,4,35,2, 1,16,35,2
	db	0,20,3, 0,28,3, 0,36,3, 0,35,3
	db	1,9,33,2, 1,16,33,2, 1,21,33,2
furelen1:
	dw	47

fur_elise_2:
	db	0,35,3, 0,36,3, 0,38,3
	db	1,12,40,2, 1,19,40,2, 1,24,40,2
	db	0,31,3, 0,41,3, 0,40,3
	db	1,7,38,2, 1,21,38,2, 1,23,38,2
	db	0,29,3, 0,40,3, 0,38,3
	db	1,9,36,2, 1,16,36,2, 1,21,36,2
	db	0,28,3, 0,38,3, 0,36,3
	db	1,4,35,2, 1,16,35,2, 0,28,3
	db	0,28,3, 0,40,3, 0,28,3, 0,40,3, 0,40,3, 0,52,3
	db	0,39,3, 0,40,3, 0,39,3, 0,40,3, 0,39,3

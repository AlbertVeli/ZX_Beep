...
sadj:
	...
	ld	b, 8
;;;speed adjustment: divide speed val by note val ch1
dloop:
	sla	h
	rla
	cp	l
...
pwtlp:
	ld	b, (hl)		;read pwm multiplier
	push	af
	push	de
	ld	d, a
pwtlp1:
	add	a,d		;multiply note byte with pwm multiplier
	djnz	pwtlp1
...
sndlp:
	ld	b, (hl)		;7	;get counter value

s1:
	out	($fe), a	;11	;send out mask
	ex	af, af'		;4
	nop			;4
	nop			;4
	nop			;4
...
pw0:
	db 4,1,9,1,3,2,2,3,1,9,1	;pwm templates (instruments)
